        ...
        <div className="inner-nav-box">
          ...
          <div className="nav">
            <nav className="links-box">
              <span className="text-sm md:text-2xl md:m-7 w-20  text-white md:hover:text-black">About</span>
              <span className="text-sm pl-5 md:p-0 md:text-2xl md:m-7 w-20  text-white md:hover:text-black">Shop</span>
              <span className="text-sm md:text-2xl md:m-7 w-20 text-white md:hover:text-black">Contact</span>
      ...
      <div className="flex flex-grow border-4 border-yellow-500">
        <div className="flex flex-col flex-grow border-4 border-green-300">
          <div className="flex h-72 md:h-2/3 border-8 border-black">
            <h2 className="text-xl p-5 tracking-wider">Two Seas Cyclery</h2>
            <div className="flex md:hidden">
             <img
                  className="border-4 border-red-600 h-auto sm:h-96 w-auto md:w-96"
